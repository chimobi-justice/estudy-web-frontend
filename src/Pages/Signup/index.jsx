...
const Signup = () => {
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="w-3/6">
        <form className="w-9/12 p-4 rounded-sm shadow-lg bg-white mx-10" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between w-full mb-8 mt-3">
            <div>
              ...
              >
                <GoogleOutlined className="mr-1" style={{color: 'red', fontSize: '17px'}}/>
            ...
            <div>
              <Link
                to=""
                className="flex items-center border border-gray-300 rounded-lg p-2 text-gray-500"
              >
                <FacebookFilled className="mr-1" style={{color: 'blue', fontSize: '17px'}}/>
